...
#     print(detections)
    ...
    viz_utils.visualize_boxes_and_labels_on_image_array(
          ...
          use_normalized_coordinates=True,
          max_boxes_to_draw=200,
          min_score_thresh=.30, # 예측한 네모박스가 적어도 확신이 30% 이상 되는것만 박스를 그린다
          agnostic_mode=False)
...
if cap.isOpened() == False :
    ...
    out = cv2.VideoWriter('data/output.avi', cv2.VideoWriter_fourcc('M','J','P','g'), 20, (frame_width, frame_height))


    # 비디오 캡쳐해서 이미지를 1장씩 가져온다
